...
<%
  ...
  // Connection string (config uses {0})
  ...
  try
  {
    if (string.Equals(Request.HttpMethod, "GET", StringComparison.OrdinalIgnoreCase))
    {
      if (!hasSortIdQuery)
      {
        ...
        Response.Write(@"{""error"":""missing or invalid sortid""}");
      ...
      Response.Write(@"""mapping"":" + mappingJson + ",");
    ...
    else if (string.Equals(Request.HttpMethod, "POST", StringComparison.OrdinalIgnoreCase))
    {
      ...
      int sortId = -1;
      int sidTmp = 0;
      bool hasSortIdBody = (obj != null && obj.ContainsKey("sortid") && obj["sortid"] != null &&
                            int.TryParse(obj["sortid"].ToString(), out sidTmp));

      if (hasSortIdBody)       sortId = sidTmp;
      else if (hasSortIdQuery) sortId = sortIdQuery;
      ...
      if (HttpContext.Current != null && HttpContext.Current.User != null &&
          HttpContext.Current.User.Identity != null && !string.IsNullOrEmpty(HttpContext.Current.User.Identity.Name))
